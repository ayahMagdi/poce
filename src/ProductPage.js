...
function ProductPage() {
  ...
  console.log(currentIndex)
   ...
   const handleclickLeft = currentIndex == 0 ? 
    ...
    const prevProuct = currentIndex == 0 ? prevandnext[prevandnext.length - 1] : prevandnext[current - 1]
    const nextProuct = currentIndex == prevandnext.length - 1 ? prevandnext[0] :  prevandnext[current + 1]
